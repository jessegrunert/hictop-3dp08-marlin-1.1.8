...
#define STRING_CONFIG_H_AUTHOR "johnsonm" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ready for printing!"
...
// Note: Changing to the correct 1.75 requires other changes
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // Hictop Custom with PID autotune
  #define  DEFAULT_Kp 4.63
  #define  DEFAULT_Ki 0.37
  #define  DEFAULT_Kd 14.42
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 98} // M8*1.25
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 394, 98}  // T8*2 (288 seems like it should be right for 1.75mm)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_PROBE_PT_2_Y 80
  #define UBL_PROBE_PT_3_X 170
  #define UBL_PROBE_PT_3_Y 80
